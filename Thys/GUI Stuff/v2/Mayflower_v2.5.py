...
def file_server():
    ...
    # add_line_to_output("Ready to receive files")
    ...
    try:
        ...
        if file_name_recv[:5] == "File:":
            ...
            # print(myfiles_list.get())
            # send_file_to_peer_download(file_name_recv[9:])
            ...
            # add_line_to_output(str(source_file_bytes))
            # print(source_file_pickle)
            # clnt_sock.sendall(source_file_pickle)
...
if __name__ == '__main__':
    ...
    tkinter.Button(window, text="Browse folder", command=scan_dir_for_files).grid(row=20, column=50, ipadx=1,
                                                                                  sticky="EW")
    ...
    tkinter.Button(window, text="Add peer manually", command=add_peer_manually).grid(row=20, column=80, columnspan=11,
                                                                                     sticky="EW")
    ...
    # Row 50
    tkinter.Button(window, text="Select file in my file list", command=select_file_in_list).grid(row=50, column=10,
                                                                                                 columnspan=11,
                                                                                                 sticky="W")
    tkinter.Button(window, text="Send file!", command=send_file_to_peer).grid(row=50, column=42, sticky="E")

    tkinter.Button(window, text="Receive peer file list", command=ask_peer_file_list).grid(row=50, column=45,
                                                                                           sticky='W')
